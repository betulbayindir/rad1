trigger StockItemTrigger on Stock_Item__c (before insert, before delete, after delete) {
    ...
    if(Trigger.isInsert && Trigger.isBefore) {
        ...
        /* I thought I could satify the requirement by comparing 'Name' field of existing records with the new one.
         I used oldMap to compare the two, and a match would have triggered the exception message
